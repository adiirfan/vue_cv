<template>
    <div>
        ...
        <div class="columns">
            <div class="column">
                <p>Atau Pengen tau lebih detail?bisa contact di</p>
            </div>
        </div>
        <div class="columns">
        ...
        data(){
            return{
                ...
                contact:[
                    {
                        nama:"email",
                        details: "adiirfan01@gmail.com",
                        gambar:'./assets/sociallogo/email.svg'
                    },
                    {
                        nama:"Whatsapp",
                        details: "081388640320",
                        gambar:'./assets/sociallogo/wa.svg'
                    }
                ]
            }
        }
